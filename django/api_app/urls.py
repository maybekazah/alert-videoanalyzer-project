...
from api_app.views.camera_settings import (
    CameraSettingsView,
    CameraSettingsDetailView
)

from api_app.views.cameras import (
    CameraView,
    CameraDetailView
)

from api_app.views.alerts import (
    AlertDataView,
    AlertDataDetailView
)

from api_app.views.health_check import (
    HealthCheckView
)

from api_app.views.redis import (
    RedisGetDataView,
    SendToNNRedisView
)

from api_app.views.auth import (
    LoginAPIView, 
    LogoutAPIView, 
...
urlpatterns = [
    ...
    # маршруты для документации openapi_app
